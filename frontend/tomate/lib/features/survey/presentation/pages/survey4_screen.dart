...
class Survey4Screen extends ConsumerStatefulWidget {
  const Survey4Screen({super.key});

  @override
  ConsumerState<Survey4Screen> createState() => _Survey4ScreenState();
}

class _Survey4ScreenState extends ConsumerState<Survey4Screen> {
  int? selectedOption;
  ...
  void _onNextPressed() {
    if (selectedOption != null) {
      GoRouter.of(context).goNamed(AppRoutes.surveyCompleteScreen.name);
    }
  }
